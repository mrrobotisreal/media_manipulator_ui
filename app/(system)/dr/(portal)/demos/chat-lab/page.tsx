...
// /dr/demos/chat-lab — the chat lab with no session open: sidebar + an empty
// state prompting the user to pick or start a chat.
export default function DrChatLabPage() {
  return (
    <Suspense
      fallback={
