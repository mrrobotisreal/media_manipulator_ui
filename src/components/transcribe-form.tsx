...
const TranscribeForm: React.FC<TranscribeFormProps> = ({ mediaKind, isLoading, onSubmit }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      <div>
        <h3 className="font-semibold text-card-foreground mb-1">Transcript Output Format</h3>
      ...
      <div>
        <label className="block text-sm font-medium mb-1 text-card-foreground">Language hint (optional)</label>
        <input
          type="text"
          value={language}
