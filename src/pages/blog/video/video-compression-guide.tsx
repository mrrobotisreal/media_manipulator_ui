    ...
    <>
      <div className="max-w-6xl mx-auto px-4 pt-4">
        <AdBanner
          ...
          adPosition="blog_video_guide_header"
          className="mb-4"
          isFlashMock={true}
          utmMedium="blog_video_guide_leaderboard"
    ...
    └─ No → MP4 (it's always MP4)`}
      ...
      <div className="max-w-6xl mx-auto px-4 pb-8">
        <AdBanner
          adSlot="3633827902"
          adFormat="leaderboard"
          adPosition="blog_video_guide_footer"
          className="mt-8"
          isFlashMock={true}
          utmMedium="blog_video_guide_footer_leaderboard"
          utmCampaign="creatv_launch_promo"
          linkURL="https://www.creatv.io/auth"
        />
      </div>
