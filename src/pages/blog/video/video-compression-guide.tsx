  ...
  return (
    <>
      <div className="max-w-7xl mx-auto px-4 pt-4">
        <AdBanner
          adSlot={AD_SLOTS.blog_video_header}
          adFormat="leaderboard"
          adPosition="blog_article_video_header"
          utmMedium="blog_video_header_leaderboard"
        />
      </div>
      <div className="max-w-[1600px] mx-auto my-2 flex flex-col lg:flex-row gap-6 px-4">
      <aside className="hidden lg:block w-[300px] shrink-0">
        <AdBanner
          adSlot={AD_SLOTS.blog_video_sidebar_left}
          adFormat="halfpage"
          adPosition="blog_article_video_sidebar_left"
          sticky
          utmMedium="blog_video_sidebar_left_halfpage"
        />
      </aside>
      ...
      <CardContent className="prose prose-lg max-w-none">
        ...
        <div className="my-12 not-prose flex justify-center">
          <AdBanner
            adSlot={AD_SLOTS.blog_video_incontent_1}
            adFormat="rectangle"
            adPosition="blog_article_video_incontent_1"
            utmMedium="blog_video_incontent_1_rectangle"
          />
        </div>
...
└─ No → Is it for editing?
    ...
    └─ No → MP4 (it's always MP4)`}
        ...
        <div className="my-12 not-prose flex justify-center">
          <AdBanner
            adSlot={AD_SLOTS.blog_video_incontent_2}
            adFormat="rectangle"
            adPosition="blog_article_video_incontent_2"
            utmMedium="blog_video_incontent_2_rectangle"
          />
        </div>
      ...
      <aside className="hidden lg:block w-[300px] shrink-0">
        <AdBanner
          adSlot={AD_SLOTS.blog_video_sidebar_right}
          adFormat="halfpage"
          adPosition="blog_article_video_sidebar_right"
          sticky
          utmMedium="blog_video_sidebar_right_halfpage"
        />
      </aside>
      </div>
      <div className="max-w-7xl mx-auto px-4 pb-8">
        <AdBanner
          adSlot={AD_SLOTS.blog_video_footer}
          adFormat="leaderboard"
          adPosition="blog_article_video_footer"
          className="mt-8"
          utmMedium="blog_video_footer_leaderboard"
        />
      </div>
    </>
  );
