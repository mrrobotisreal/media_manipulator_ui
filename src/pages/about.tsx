          ...
          <div className="prose max-w-none text-muted-foreground">
            ...
            <section className="mb-10">
              ...
              <p className="mt-6">
                <Trans
                  ...
                  components={{
                    linkTutorials: <Link to="/tutorials" className="text-blue-600 hover:text-blue-800" />,
                    linkHow: <Link to="/how-it-works" className="text-blue-600 hover:text-blue-800" />,
                  }}
                />
              </p>
            </section>
                ...
                <div className="bg-card p-6 sci-fi-frame-inner">
                  ...
                  <p>
                    <Trans
                      ...
                      components={{
                        strong: <strong />,
                        linkPrivacy: <Link to="/privacy-policy" className="text-blue-600 hover:text-blue-800" />,
                      }}
                    />
                  </p>
                </div>
            ...
            <section className="mb-10">
              ...
              <p className="mb-4">
                <Trans
                  ...
                  components={{ linkHome: <Link to="/" className="text-blue-600 hover:text-blue-800" /> }}
                />
              </p>
              <div className="grid md:grid-cols-2 gap-6">
                <div>
            ...
            <section className="mb-10">
              ...
              <p className="mb-4">
                ...
                <Link to="/how-it-works" className="text-blue-600 hover:text-blue-800">{t('topNav.howItWorks')}</Link>{' · '}
                <Link to="/tutorials" className="text-blue-600 hover:text-blue-800">{t('topNav.tutorials')}</Link>{' · '}
                <Link to="/privacy-policy" className="text-blue-600 hover:text-blue-800">{t('topNav.privacyPolicy')}</Link>{' · '}
                <Link to="/terms-of-service" className="text-blue-600 hover:text-blue-800">{t('topNav.termsOfService')}</Link>
              </p>
            </section>
