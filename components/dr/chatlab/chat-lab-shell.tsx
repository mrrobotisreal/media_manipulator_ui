...
// Two-pane chat-lab layout (mirrors feedback-shell.tsx): a fixed 280px sidebar
// on md+ and, below md, a Sheet toggled from a small header button. The main
// pane owns its own internal scrolling (the DR shell renders this route
// full-bleed).
    ...
    <div className="flex min-h-0 w-full flex-1">
      ...
      <div className="flex min-h-0 min-w-0 flex-1 flex-col">
        ...
        <div className="flex items-center gap-2 border-b border-border px-2 py-1.5 md:hidden">
          ...
          <span className="text-sm font-semibold">DR AI Chat Test Lab</span>
        </div>
        {children}
      </div>
    </div>
